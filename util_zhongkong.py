...
def addUserPermission(connection1, connection2, userList: list, subscriptionList: list):
    for subscriptionName in subscriptionList:
        oldUserList = get_subscription_userlist(connection1, subscriptionName)
        set_subscription_userlist(connection2, subscriptionName, list(set(oldUserList) | set(userList)))


def removeUserPermission(connection1, connection2, userList: list, subscriptionList: list):
    for subscriptionName in subscriptionList:
        oldUserList = get_subscription_userlist(connection1, subscriptionName)
        set_subscription_userlist(connection2, subscriptionName, list(set(oldUserList) - set(userList)))
